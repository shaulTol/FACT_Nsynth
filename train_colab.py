...
sys.path.append('/content/AFourier-based-Framework-for-Domain-Generalization')
from utils.compatibility import apply_compatibility_patches

# Apply patches before importing PyTorch
...
class Trainer:
    ...
    def _do_epoch(self):
        ...
        for it, (batch, label, domain) in enumerate(self.train_loader):
            ...
            # Update for PyTorch 2.x compatibility - specify reduction method
