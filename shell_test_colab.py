...
output_dir = '/content/AFourier-based-Framework-for-Domain-Generalization/test_logs'
ckpt_path = f'/content/AFourier-based-Framework-for-Domain-Generalization/ckpt/{target}/best_model.tar'
...
for i in range(args.times):
    ...
    os.system(f'python /content/AFourier-based-Framework-for-Domain-Generalization/test_colab.py '
