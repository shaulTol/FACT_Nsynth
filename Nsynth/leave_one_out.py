...
def run_leave_one_out():
    """Run leave-one-domain-out training for all domains."""
    ...
    for target_domain in all_domains:
        ...
        test_acc = trainer.train(
            ...
            save_dir='/content/AFourier-based-Framework-for-Domain-Generalization/Nsynth/models'
        )
    ...
    # Save results
    with open('/content/AFourier-based-Framework-for-Domain-Generalization/Nsynth/nsynth_domain_results.json', 'w') as f:
